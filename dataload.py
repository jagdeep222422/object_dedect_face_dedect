...
def snapshot():
    ...
    for face_location in face_locations:
        ...
        name=name_var.get()
        im1.save(r'C:\Users\Pradeep kumar mahato\Downloads\facereco\facereco-main\images\''+name+'.jpg')
        
def updatedata():
    path = r'C:\Users\Pradeep kumar mahato\Downloads\facereco\facereco-main\images\'*.*'
